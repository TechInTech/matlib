...
z2 = W1*data+repmat(b1,1,m); % (hiddenSize, m)
a2 = sigmoid(z2);
z3 = W2*z2+repmat(b2,1,m); % (visibleSize,m) = (visibleSize, hiddenSize) * (hiddenSize, m) + (visibleSize, m)
a3 = sigmoid(z3);
...
cost = Jcost + Jweight + beta * Jsparse;
